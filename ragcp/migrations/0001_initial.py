# Generated by Django 2.2.1 on 2019-05-10 23:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('char_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ragcp.Char')),
            ],
            options={
                'db_table': 'guild',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userid', models.CharField(max_length=23, unique=True, verbose_name='Username')),
                ...
                ('email', models.CharField(max_length=39, unique=True, verbose_name='Email')),
                ('group_id', models.IntegerField(default=1, null=True)),
                ('state', models.PositiveIntegerField(default=0, null=True)),
                ('unban_time', models.PositiveIntegerField(default=0, null=True)),
                ('expiration_time', models.PositiveIntegerField(default=0, null=True)),
                ('logincount', models.PositiveIntegerField(default=0, null=True)),
                ('lastlogin', models.DateTimeField(blank=True, null=True)),
                ('last_ip', models.CharField(max_length=100)),
                ('birthdate', models.DateField(blank=True, null=True)),
                ('character_slots', models.PositiveIntegerField(default=0, null=True)),
                ('pincode', models.CharField(max_length=4)),
                ('pincode_change', models.PositiveIntegerField(default=0, null=True)),
                ('vip_time', models.PositiveIntegerField(default=0, null=True)),
                ('old_group', models.IntegerField(default=0, null=True)),
            ],
            options={
                'db_table': 'login',
                'managed': True,
        ...
        migrations.CreateModel(
            name='MercenaryOwner',
            fields=[
                ('char_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='ragcp.Char')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ragcp.Login')),
                ('char_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ragcp.Char')),
            ],
            options={
                'db_table': 'vendings',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bound', models.PositiveIntegerField()),
                ('char_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ragcp.Char')),
                ('guild_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ragcp.Guild')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='char',
            name='account_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ragcp.Login'),
        ),
        migrations.CreateModel(
            name='CartInventory',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('homun_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='ragcp.Homunculus')),
        ...
        migrations.CreateModel(
            name='GuildSkill',
            fields=[
                ('guild_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='ragcp.Guild')),
                ('id', models.PositiveSmallIntegerField()),
                ('lv', models.PositiveIntegerField()),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('account_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='ragcp.Login')),
        ...
        migrations.CreateModel(
            name='ClanAlliance',
            fields=[
                ('clan_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='ragcp.Clan')),
                ('opposition', models.PositiveIntegerField()),
                ('alliance_id', models.PositiveIntegerField()),
                ('name', models.CharField(max_length=24)),
            ],
